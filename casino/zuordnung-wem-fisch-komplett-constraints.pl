...
c5a( Marlboro, Katze ) :- A #= Katze + 1, Marlboro #= A.
c5b( Marlboro, Katze ) :- B #= Katze - 1, Marlboro #= B.
c6( Norwegen, Blau ) :- c6a( Norwegen, Blau ).
c6( Norwegen, Blau ) :- c6b( Norwegen, Blau ).
c6a( Norwegen, Blau ) :- A #= Norwegen + 1, Blau #= A.
c6b( Norwegen, Blau ) :- B #= Norwegen - 1, Blau #= B.
...
c11a( Dunhill, Pferd ) :- A #= Pferd + 1, Dunhill #= A.
c11b( Dunhill, Pferd ) :- B #= Pferd - 1, Dunhill #= B.
c12( Gruen, Kaffee ) :- Gruen #= Kaffee.
% c13( Gruen, Weiss ) :- A #= Weiss - 1, Gruen #= A.
c13( Gruen, Weiss ) :- Gruen #= Weiss - 1.
c14( Milch ) :- Milch #= 3.
c15( Marlboro, Wasser ) :- c15a( Marlboro, Wasser ).
c15( Marlboro, Wasser ) :- c15b( Marlboro, Wasser ).
c15a( Marlboro, Wasser ) :- A #= Marlboro + 1, Wasser #= A.
c15b( Marlboro, Wasser ) :- B #= Marlboro - 1, Wasser #= B.
...
label([Rot, Gelb, Blau, Gruen, Weiss,
         England, Schweden, Norwegen, Daenemark, Deutschland,
	 Bier, Tee, Kaffee, Milch, Wasser,
	 Hund, Katze, Vogel, Pferd, Fisch,
	 Dunhill, Rothmanns, Marlboro, Pallmall, Winfield]).
